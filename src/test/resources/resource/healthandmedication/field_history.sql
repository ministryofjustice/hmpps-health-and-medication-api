INSERT INTO field_history (field_history_id, prisoner_number, field, value_ref, value_string, value_json, created_at, created_by)
VALUES (-201, 'A1234AA', 'FOOD_ALLERGY', null, null,
       ...
       (-204, 'A1234AA', 'CATERING_INSTRUCTIONS', null, 'Serve dessert before the main course.',
        null, '2024-01-02 09:10:11.123', 'USER1');
