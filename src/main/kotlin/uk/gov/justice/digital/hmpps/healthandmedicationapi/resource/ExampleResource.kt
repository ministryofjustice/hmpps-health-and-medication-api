package uk.gov.justice.digital.hmpps.healthandmedicationapi.resource
...
import uk.gov.justice.digital.hmpps.healthandmedicationapi.service.ExampleApiService
...
class ExampleResource(private val exampleApiService: ExampleApiService) {
  ...
  @Operation(
    ...
    security = [SecurityRequirement(name = "health-and-medication-api-ui-role")],
    responses = [
