...
fun validatePrisonerNumber(
  prisonerSearchClient: PrisonerSearchClient,
  prisonerNumber: String,
) = require(prisonerSearchClient.getPrisoner(prisonerNumber)?.prisonerNumber == prisonerNumber) {
  "Prisoner number '$prisonerNumber' not found"
}
